 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | LCtrl| LAlt | LGUI | Lower|    Space    | Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_mit(
    ...
    MO(_FUNCTION), KC_LCTL, KC_LALT, KC_LGUI, MO(_LOWER),      KC_SPC,        MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_mit(
    KC_GRV,  KC_3,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_TRNS,
 ...
 * |      |      |      |      |      |      |      |      | Left | Down | Right|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | LCtrl| LAlt | LGUI |      |      |      |      |      |  Br- |  Br+ |      |
 * `-----------------------------------------------------------------------------------'
 */
[_FUNCTION] = LAYOUT_planck_mit(
    KC_NO,   KC_F1,     KC_F2,   KC_F3,   KC_F4,   KC_F5, KC_F6, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,
    KC_NO,   KC_F11,    KC_F12,  KC_NO,   KC_NO,   KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,
    KC_NO,   KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO, KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,
    KC_TRNS, KC_LCTL,   KC_LALT, KC_LGUI, KC_TRNS,      KC_NO,   KC_TRNS, KC_NO,   KC_BRID, KC_BRIU, KC_NO
)
};
